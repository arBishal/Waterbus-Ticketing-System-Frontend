...
export default function TicketingPolicePlaza() {
  const [departure, setDeparture] = useState("Police Plaza");
    ...
    <>
      <div className={ticketingStyle.page}>
        ...
        <div className={ticketingStyle.section} style={{ overflow: "hidden" }}>
          <h1 className={ticketingStyle.title}> Station: Police Plaza</h1>
          <form className={ticketingStyle.form} onSubmit={handleSubmitFilter}>
            <div className={ticketingStyle.innerForm}>
              ...
              <select
                ...
                required
              >
                <option value={departure}>Police Plaza</option>
              </select>
